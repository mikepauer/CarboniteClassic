	...
	Nx.Skins = {
		["Blackout"] = {
			...
			["Backdrop"] = {
				...
				["edgeFile"] = "Interface\\Addons\\CarboniteClassic\\Gfx\\Skin\\EdgeSquare",
				["tile"] = true,
				["tileSize"] = 8,
				["edgeSize"] = 8,
...
function Nx.Skin:Set (skinName, init)
	...
	self.Path = "Interface\\Addons\\CarboniteClassic\\Gfx\\Skin\\" .. data["Folder"]
...
Nx.Button.TypeData = {
	...
	["Scroll"] = {
		Scroll = true,
		Up = "Interface\\Addons\\CarboniteClassic\\Gfx\\Buttons\\ScrollUp",
		Dn = "Interface\\Addons\\CarboniteClassic\\Gfx\\Buttons\\ScrollUp",
		SizeUp = 14,
		SizeDn = 12,
	},
	["Tab"] = {
